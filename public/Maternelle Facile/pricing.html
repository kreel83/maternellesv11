...
<body>
                        ...
                        <nav class="navbar p-0">
                            ...
                            <div class="header-menu position-static">
                                <ul class="menu">
                                    ...
                                    <li><a href="about.html">l'application</a></li>
                                    <li><a href="service.html">le compagnon</a></li>
    ...
    <!-- start banner area -->
    <section class="inner-page banner" data-img="assets/images/inner/banner-bg2.png">
        <div class="overlay">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="item text-center wow fadeInLeft" data-wow-delay="0.2s" data-wow-duration="1s">
                                <div class="price-title">
                                    <h5>Version découverte</h5>
                                    <h4>"individual"</h4>
                                </div>
                                <ul>
                                    <li><i class="fas fa-check"></i>10 évaluations par classe</li>
                                    <li><i class="fas fa-check"></i>Création de fiches illimitées</li>
                                    <li><i class="fas fa-check"></i></li>
                                    <li><i class="fas fa-check"></i>unlimited bandwidth</li>
                                    <li><i class="fas fa-times not"></i>support reports</li>
                                    <li><i class="fas fa-times not"></i>30 GB  uploads</li>
                                </ul>
                                <div class="purchase">
                                    <h3>$49 <span>"/3 months"</span></h3>
                                    <a href="#!">start purchase</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="item text-center active wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="1s">
                                <div class="price-title">
                                    <span>popular</span>
                                    <h5>Professeur titulaire</h5>
                                    <!-- <h4>"business"</h4> -->
                                </div>
                                <ul>
                                    <li><i class="fas fa-check"></i>5 email address</li>
                                    <li><i class="fas fa-check"></i>50 space users</li>
                                    <li><i class="fas fa-check"></i>30 GB space</li>
                                    <li><i class="fas fa-check"></i>unlimited bandwidth</li>
                                    <li><i class="fas fa-times not"></i>support reports</li>
                                    <li><i class="fas fa-times not"></i>50 GB  uploads</li>
                                </ul>
                                <div class="purchase">
                                    <h3>$79 <span>"/3 months"</span></h3>
                                    <a href="#!">start purchase</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="item text-center wow fadeInRight" data-wow-delay="0.6s" data-wow-duration="1s">
                                <div class="price-title">
                                    <h5>Professeur suppléant</h5>
                                    <!-- <h4>"enterprise"</h4> -->
                                </div>
                                <ul>
                                    <li><i class="fas fa-check"></i>10 email address</li>
                                    <li><i class="fas fa-check"></i>60 space users</li>
                                    <li><i class="fas fa-check"></i>50 GB space</li>
                                    <li><i class="fas fa-check"></i>unlimited bandwidth</li>
                                    <li><i class="fas fa-times not"></i>support reports</li>
                                    <li><i class="fas fa-times not"></i>60 GB  uploads</li>
                                </ul>
                                <div class="purchase">
                                    <h3>$99 <span>"/3 months"</span></h3>
                                    <a href="#!">start purchase</a>
                                </div>
                            </div>
                        </div>
