...
<li class="card_fiche shadowDepth1 ui-state-default" data-table="{{$fiche->getTable()}}" data-type="{{$type}}" data-level="{{$lvl}}" data-fiche="{{$fiche->id}}" data-ps="{{$ps}}" data-ms="{{$ms}}" data-gs="{{$gs}}">
