    ...
    <div class="col-md-6">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item " role="presentation">
              <button class="nav-link active text-white" id="animaux-tab" data-bs-toggle="tab" data-bs-target="#animaux-tab-pane" type="button" role="tab" aria-controls="animaux-tab-pane" aria-selected="true">Figurines</button>
            </li>
            <li class="nav-item" role="presentation">
              <button class="nav-link btn_fond text-white" id="fonds-tab" data-bs-toggle="tab" data-bs-target="#fonds-tab-pane" type="button" role="tab" aria-controls="fonds-tab-pane" aria-selected="false">Fonds</button>
            </li>
