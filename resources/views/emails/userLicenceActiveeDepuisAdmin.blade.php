...
<body id="BodyMail">
    ...
    <div id="body">
        <p>
            ...
            Bonjour,
            <br><br>
            Nous sommes ravis de vous informer qu'une licence a été activée par votre établissement.
            <br><br>
            Vous pouvez dès à présent vous connecter à votre compte en <a href="{{ route('login') }}">cliquant ici</a>.
            <br><br><br><br>
