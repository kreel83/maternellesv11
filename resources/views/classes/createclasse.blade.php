...
<div class="mt-5 container" id="creation_classe">
    ...
    <div class="card mx-auto w-75" style="border: none; border-radius: 40px; margin-top: 100px; margin-bottom: 30px">
        ...
        @foreach ($liste as $partage)
            <div class="d-flex align-items-center">
                <div class="mx-3 pt-3">
                    <i class="fas fa-circle" style="color: var(--main-color)"></i>
                </div>
