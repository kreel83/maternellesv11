    ...
    <div class="container">
        ...
        <div class="card m-auto mt-5 h-auto" style="height: 600px !important">
            <div class="card-body " >
              ...
              <p class="text-center h4">Je crée mon compte sur<br>Les Maternelles</p>

              <div class="flex text-center items-center justify-end mt-3">
                ...
                <a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('login') }}">
                    {{ __('se connecter') }}
                        ...
                        <form method="POST" action="{{ route('storeProf') }}">
                            @csrf
    
                            <!--<p class="mt-4">Ma fonction au sein de l'établissement :</p>-->

                            <select id="role" name="role" class="form-select form-select-md mb-3 mt-5" aria-label=".form-select-lg example" required autofocus>
                                <option value="">Ma fonction au sein de l'établissement</option>
                                <option value="Prof">Enseignant(e)</option>
                                <option value="Direction">Directrice / Directeur</option>
                                <option value="Mixte">Directrice / Directeur et enseignant(e)</option>
                              </select>
                            
                                <!--
                                <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                    <input type="radio" class="btn-check" name="role1" id="btnradio1" autocomplete="off">
                                    <label class="btn btn-outline-primary" for="btnradio1">Enseignant(e)</label>
                                
                                    <input type="radio" class="btn-check" name="role1" id="btnradio2" autocomplete="off">
                                    <label class="btn btn-outline-primary" for="btnradio2">Directeur / Directrice</label>
                                
                                    <input type="radio" class="btn-check" name="role1" id="btnradio3" autocomplete="off">
                                    <label class="btn btn-outline-primary" for="btnradio3">Directrice / Directeur et enseignant(e)</label>
                                </div>
                            -->
