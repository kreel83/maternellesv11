    ...
    <div style="overflow-y: auto; height: 550px" class="pe-2">
        ...
        <div class="d-flex justify-content-between mb-2 bloc_genre">
            <div class="input-group text-center" style="border-right: 3px solid var(--main-color)">
                ...
                <label class="btn label-genre-check {{$eleve['genre'] == 'F' ? 'checked' : null}}" id="labelgenref" for="genref">Fille</label>
            </div>
            
            <div class="input-group d-flex justify-content-end">
                <span class="input-group-text" id="basic-addon2"><i class="fa-solid fa-mars"></i></span> 
                <input type="radio" class="btn-check genre-check" name="genre" id="genreg" value="G" {{$eleve['genre'] == 'G' ? 'checked' : null}}>
                <label class="btn label-genre-check {{$eleve['genre'] == 'G' ? 'checked' : null}}" id="labelgenreg" for="genreg">Garcon</label>
            </div>
